...
var logger = logger || require('../common/logger');
...
function VAST_Voronoi(bbox) {
    ...
    //log = LOG.newLayer('vast_voro', 'vast_voro', 'logs', 1, 0);
    ...
    if (bbox === undefined)
        ...
        bbox = {xl: -STANDARD_SIZE/2, xr: STANDARD_SIZE/2, yt: -STANDARD_SIZE/2, yb: STANDARD_SIZE/2};
        //bbox = {xl:0, xr: CONF.x_lim, yt:0, yb: CONF.y_lim};
    ...
    */
    ...
    this.collidesID = function(id, center, radius){
        return collides(id2idx[id], center, radius);
    }
