...
global.Matcher_Event = {
	MATCHER_JOIN :  0, // matcher joined the VON
	MATCHER_MOVE :  1, // matcher moved in the VON (not used)
  MATCHER_LEAVE:  9, // matcher left the VON (not used)
  CLIENT_JOIN :   2, // client connected to the matcher
  CLIENT_MOVE :   3, // client moved to a new position
  CLIENT_LEAVE :  4, // client disconnected from the matcher
	SUB_NEW :       5, // new subscription added to the matcher
  SUB_UPDATE :    6, // subscription updated
  SUB_DELETE :    7, // subscription deleted
  PUB :           8, // received a publication from client
  DISSEMINATE:    10 // disseminate a publication to client 
}
