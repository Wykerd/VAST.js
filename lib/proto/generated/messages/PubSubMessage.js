...
function encodeJson(value) {
    ...
    if (value.payload !== undefined)
        result.payload = scalar_js_1.tsValueToJsonValueFns.bytes(value.payload);
...
function decodeJson(value) {
    ...
    if (value.payload !== undefined)
        result.payload = scalar_js_1.jsonValueToTsValueFns.bytes(value.payload);
    if (value.channel !== undefined)
...
function encodeBinary(value) {
    ...
    if (value.payload !== undefined) {
        ...
        result.push([1, scalar_js_2.tsValueToWireValueFns.bytes(tsValue)]);
    }
    if (value.channel !== undefined) {
