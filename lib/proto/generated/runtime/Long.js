...
exports.UINT32_MAX = exports.UINT16_MAX = void 0;
exports.add = add;
exports.sub = sub;
exports.mul = mul;
exports.divByTen = divByTen;
...
function makeChunk(value) {
    const [lo, hi] = value;
    return [lo & exports.UINT16_MAX, lo >>> 16, hi & exports.UINT16_MAX, hi >>> 16];
}
function add(a, b) {
    ...
    c00 += a00 + b00;
    c16 += c00 >>> 16;
    c00 &= exports.UINT16_MAX;
    c16 += a16 + b16;
    c32 += c16 >>> 16;
    c16 &= exports.UINT16_MAX;
    c32 += a32 + b32;
    c48 += c32 >>> 16;
    c32 &= exports.UINT16_MAX;
    c48 += a48 + b48;
    c48 &= exports.UINT16_MAX;
...
function divByTen(value) {
    const [lo, hi] = value;
    return [
        new Long((((hi % 10) * (exports.UINT32_MAX + 1) + lo) / 10) | 0, (hi / 10) | 0),
        ((hi % 10) * (exports.UINT32_MAX + 1) + lo) % 10,
    ];
}
