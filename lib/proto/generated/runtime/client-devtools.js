...
exports.devtoolsKey = void 0;
exports.registerRemoteDevtools = registerRemoteDevtools;
exports.getDevtoolsConfig = getDevtoolsConfig;
exports.wrapRpcClientImpl = wrapRpcClientImpl;
const event_emitter_js_1 = require("./async/event-emitter.js");
exports.devtoolsKey = "@pbkit/devtools";
function registerRemoteDevtools(host) {
...
function createDevtoolsConfig() {
    const devtoolsConfig = {
        ...
        requestIdCounter: 0,
        ...(0, event_emitter_js_1.createEventEmitter)(),
    };
