...
function deserialize(uint8array) {
    ...
    while (idx < uint8array.length) {
        const decodeResult = (0, varint_js_1.decode)(new DataView(uint8array.buffer, offset + idx));
        ...
        switch (type) {
            ...
            case index_js_1.WireType.Varint: {
                const [len, value] = (0, varint_js_1.decode)(new DataView(uint8array.buffer, offset + idx));
            ...
            case index_js_1.WireType.Fixed64:
                ...
                result.push([fieldNumber, {
                        type,
                        value: new Long_js_1.default(lo, hi),
                    }]);
                break;
            ...
            case index_js_1.WireType.EndGroup:
